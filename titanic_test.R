...
titanic<-read.csv('/Users/jorgeramirezcarrasco/Desktop/COM/ML-Experiments-master/datasets/test.csv',header=TRUE,sep=',')
...
titanic$Survived<-ifelse(predict(logmodel,newdata=titanic,type='response')>0.44,1,0)
             
#....Creamos dataframe de test

titanic_test <- titanic[c("PassengerId","Survived")]
